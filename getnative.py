...
# and imwri for png/bmp input: 64bit: https://ddl.kageru.moe/kV1EM.7z
# if that doesn't work or if you need 32bit: http://forum.doom9.org/showthread.php?p=1769737#post1769737
